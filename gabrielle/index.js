...
// Rota para contar a quantidade de inscrições por curso //like
app.get('/api/contarInscricoes/:id_curso', async (req, res) => {
    const { id_curso } = req.params;
    
    try {
        // Contando quantas inscrições existem para o curso específico
